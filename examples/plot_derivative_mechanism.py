...
of 5.6 from order 0 to order 5. PHA averages the per-order matrices with
*equal* weight, so order 5 alone accounts for about 43% of that unweighted
...
around 0.87) while order 0 stands apart (around 0.36 against the rest). So the
